...
class UWCNN(BaseNet):
    ...
    def _init_layers(self):
        self.conv2d_dehaze1 = nn.Conv2d(in_channels=3, out_channels=16, kernel_size=3, stride=1, padding=1)
        self.dehaze1_relu = nn.ReLU(inplace=True)

        self.conv2d_dehaze2 = nn.Conv2d(in_channels=16, out_channels=16,kernel_size= 3, stride=1, padding=1)
        self.dehaze2_relu = nn.ReLU(inplace=True)

        self.conv2d_dehaze3 = nn.Conv2d(in_channels=16, out_channels=16, kernel_size=3, stride=1, padding=1)
        self.dehaze3_relu = nn.ReLU(inplace=True)

        self.conv2d_dehaze4 = nn.Conv2d(in_channels=3+16+16+16, out_channels=16, kernel_size=3, stride=1, padding=1)
        self.dehaze4_relu = nn.ReLU(inplace=True)

        self.conv2d_dehaze5 = nn.Conv2d(in_channels=16, out_channels=16, kernel_size=3, stride=1, padding=1)
        self.dehaze5_relu = nn.ReLU(inplace=True)

        self.conv2d_dehaze6 = nn.Conv2d(in_channels=16, out_channels=16, kernel_size=3, stride=1, padding=1)
        self.dehaze6_relu = nn.ReLU(inplace=True)

        self.conv2d_dehaze7 = nn.Conv2d(in_channels=51+48, out_channels=16, kernel_size=3, stride=1, padding=1)
        self.dehaze7_relu = nn.ReLU(inplace=True)

        self.conv2d_dehaze8 = nn.Conv2d(in_channels=16,out_channels= 16, kernel_size=3,stride= 1, padding=1)
        self.dehaze8_relu = nn.ReLU(inplace=True)

        self.conv2d_dehaze9 = nn.Conv2d(in_channels=16, out_channels=16, kernel_size=3, stride=1, padding=1)
        self.dehaze9_relu = nn.ReLU(inplace=True)

        self.conv2d_dehaze10 = nn.Conv2d(in_channels=99+48, out_channels=3, kernel_size=3,stride= 1, padding=1)
    ...
    def forward(self, x:torch.Tensor)->torch.Tensor:
        ...
        dehaze_concat1 = torch.cat(tensors=[image_conv1, image_conv2, image_conv3, x], dim=1)
        ...
        dehaze_concat2 = torch.cat(tensors=[dehaze_concat1, image_conv4, image_conv5, image_conv6], dim=1)
        ...
        dehaze_concat3 = torch.cat(tensors=[dehaze_concat2, image_conv7, image_conv8, image_conv9], dim=1)
